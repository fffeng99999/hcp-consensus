...
// computeSubRoots 并行计算子块 Merkle 根。
...
// merkleRootFromTxs 从交易列表计算 Merkle 根。
...
// merkleRootFromHashes 从叶子哈希计算 Merkle 根。
